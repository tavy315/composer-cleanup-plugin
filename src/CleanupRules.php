...
class CleanupRules
{
    public static function getRules()
    {
        ...
        $docs = 'README* CHANGELOG* FAQ* CONTRIBUTING* HISTORY* UPGRADING* UPGRADE* package* demo demos example examples doc docs readme*';
        ...
        return [
            ...
            'tavy315/zfdebug'                       => [ $docs, 'license.txt' ],
            'tavy315/zendframework1'                => [ $docs, 'bin', 'resources', 'LICENSE.txt', 'INSTALL.MD', 'DEVELOPMENT_README.md' ],
